...
export default function SprintSeptemberPage() {
  ...
  const lessons = [
    {
      id: 1,
      title: "Введение в ИИ-ассистентов",
      duration: "45 мин",
      description: "Основы работы с ChatGPT, Claude и другими ИИ-помощниками",
      completed: false
    },
    {
      id: 2,
      title: "Эффективные промпты для ИИ",
      duration: "60 мин",
      description: "Техники создания качественных запросов к ИИ-ассистентам",
      completed: false
    },
    {
      id: 3,
      ...
      duration: "50 мин",
      description: "Автоматизация рутинных задач с помощью ИИ-помощников",
      completed: false
    },
    {
      id: 4,
      title: "Персональные ИИ-ассистенты",
      duration: "55 мин",
      description: "Настройка и кастомизация ИИ под личные потребности",
      completed: false
    },
    {
      id: 5,
      title: "Этика работы с ИИ-ассистентами",
      duration: "40 мин",
      description: "Ответственное использование ИИ-технологий",
      completed: false
    }
  ];
      ...
      <div className="flex flex-col items-center min-h-screen px-4 sm:px-6 lg:px-8 pt-20 pb-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Актуальный курс работы с ИИ-ассистентами
          </p>
        </div>
